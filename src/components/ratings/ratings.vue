<template>
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <split></split>
      <ratingSelect :bus="bus"   :onlyContent="onlyContent" :selectType="selectType" :ratings="ratings"></ratingSelect>
          ...
          <li v-show="needShow(rating.rateType,rating.text)" v-for="(rating, index) in ratings" class="rating-item" :key="index">
            ...
            <div class="content" >
              ...
              <div class="recommend" v-show="rating.recommend && rating.recommend.length">
                ...
                <span class="item" v-for="(recommend,num) in rating.recommend" :key="num">{{recommend}}</span>
              </div>
              <div class="time">
